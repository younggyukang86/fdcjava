...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        while(true) {
            System.out.println("명렁어를 입력하여 주세요. (DBCP TEST)");
    ...
    private static void addData(Integer max) throws Exception {
        ...
        try {
            String query = "INSERT INTO test.\"user2\" (\"NAME\", \"COMMENT\", \"NUMBER1\", \"NUMBER2\"";
            for (int i = 1; i <= 100; i++) {
                query += ",\"C" + i + "\"";
            }
            query += ") VALUES (?, ?, ?, ?";
    ...
    public static void statementAddData(Integer max) throws Exception {
        ...
        try {
            String insertQuery = "INSERT INTO test.\"user2\" (\"NAME\", \"COMMENT\", \"NUMBER1\", \"NUMBER2\"";
            for (int i = 1; i <= 100; i++) {
                insertQuery += ",\"C" + i + "\"";
            }
            insertQuery += ") VALUES (";
    ...
    private static void deleteData() throws Exception {
        ...
        try {
            String query = "TRUNCATE TABLE test.\"user2\"";
    ...
    private static List<User> getData() throws Exception {
        ...
        try {
            String sql = "SELECT * FROM test.\"user2\"";
    ...
    private static void createTable() throws Exception {
        String sql = "CREATE TABLE test.user2 (";
        ...
        sql += "CONSTRAINT user2_pkey PRIMARY KEY (\"ID\"));";
    ...
    private static void deleteTable() throws Exception {
        String sql = "DROP TABLE test.user2;";
        Db db = Db.getInstance();
        Connection connection = db.getConnection();
        PreparedStatement pstmt = null;
